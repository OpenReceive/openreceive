...
// Executes the canonical OpenReceive DDL: \`openreceive_payments\` and the
// \`openreceive_meta\` reconcile gate, both tables in this one migration.
...
${body}
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query("DROP TABLE IF EXISTS openreceive_meta");
    await queryRunner.query("DROP TABLE IF EXISTS openreceive_payments");
  }
}
`;
