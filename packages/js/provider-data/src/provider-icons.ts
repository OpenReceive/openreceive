...
export const openReceiveProviderIconUrls: Readonly<Record<string, string>> = {
  ...
  "assets/provider-icons/bipa.png": bipaIcon,
  "assets/provider-icons/bitfinex.png": bitfinexIcon,
  "assets/provider-icons/bitget.png": bitgetIcon,
  "assets/provider-icons/bitnob.png": bitnobIcon,
  "assets/provider-icons/bitso.png": bitsoIcon,
  "assets/provider-icons/bity.png": bityIcon,
  "assets/provider-icons/blink.png": blinkIcon,
  "assets/provider-icons/bluewallet.png": bluewalletIcon,
  "assets/provider-icons/boltz.png": boltzIcon,
  "assets/provider-icons/bringin.png": bringinIcon,
  "assets/provider-icons/bullbitcoin.png": bullbitcoinIcon,
  "assets/provider-icons/cakewallet.png": cakewalletIcon,
  "assets/provider-icons/cashapp.png": cashappIcon,
  "assets/provider-icons/changenow.png": changenowIcon,
  "assets/provider-icons/chivo.png": chivoIcon,
  "assets/provider-icons/coinbase.png": coinbaseIcon,
  "assets/provider-icons/coincorner.png": coincornerIcon,
  "assets/provider-icons/fixedfloat.png": fixedfloatIcon,
  "assets/provider-icons/getalby.png": getalbyIcon,
  "assets/provider-icons/kraken.png": krakenIcon,
  ...
  "assets/provider-icons/pouch.png": pouchIcon,
  "assets/provider-icons/ripio.png": ripioIcon,
  "assets/provider-icons/river.png": riverIcon,
  "assets/provider-icons/rizful.png": rizfulIcon,
  "assets/provider-icons/shakepay.png": shakepayIcon,
  "assets/provider-icons/sideshift.png": sideshiftIcon,
  "assets/provider-icons/simpleswap.png": simpleswapIcon,
  "assets/provider-icons/speed.png": speedIcon,
  "assets/provider-icons/strike.png": strikeIcon,
  "assets/provider-icons/trocador.png": trocadorIcon,
  "assets/provider-icons/walletofsatoshi.png": walletofsatoshiIcon,
  "assets/provider-icons/zeus.png": zeusIcon
};
