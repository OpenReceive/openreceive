...
/**
 * The Laravel host — the same MINIMAL shape as the Fastify one.
 *
 ...
 * Laravel-mounted OpenReceive engine. The catalog, the cart, the receipt and
...
export const ShopApp: React.FC = () => {
  ...
  // The Node hosts and this one fetch the bootstrap payload; Rails inlines it. Everything
    ...
    <MantineProvider theme={shopTheme} defaultColorScheme="light">
      <main className="or-page">
        <div className="or-page-inner">
          ...
          <Text className="or-page-note">Laravel + Postgres. React.</Text>
        </div>
      </main>
    </MantineProvider>
  );
