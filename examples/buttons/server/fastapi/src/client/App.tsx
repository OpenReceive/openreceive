...
/**
 * The FastAPI host — the MINIMAL one, the Fastify twin in Python.
 *
 ...
 * FastAPI-included OpenReceive router. The catalog, the cart, the receipt and
    ...
    <MantineProvider theme={shopTheme} defaultColorScheme="light">
      <main className="or-page">
        <div className="or-page-inner">
          ...
          <Text className="or-page-note">FastAPI + SQLite. React.</Text>
        </div>
      </main>
    </MantineProvider>
  );
