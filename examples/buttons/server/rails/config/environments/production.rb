...
Rails.application.configure do
  ...
  # Local Docker demo is plain HTTP. Real deployments should terminate TLS upstream
  # and set FORCE_SSL=true.
  ...
  # Demo containers are reached as localhost / compose service names.
  config.hosts.clear
end
