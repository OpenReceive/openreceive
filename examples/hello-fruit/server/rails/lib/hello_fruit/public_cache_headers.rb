...
module HelloFruit
  ...
  # Digested Shakapacker files (`/packs/js/hello_fruit-<contenthash>.js`) may be
  # cached forever. The HTML that names those digests must not, or a rebuild
  # leaves browsers on a dead bundle. Unhashed OpenReceive runtime images
  # (copied next to the chunk at /packs/js/assets/…) revalidate.
  class PublicCacheHeaders
    ...
    # Content-hash suffix: hello_fruit-a1b2c3d4.js (Propshaft-style 8 hex) or
    # hello_fruit-3b4c5d6e7f8091a2b3c4.js (webpack contenthash), incl. .js.map.
    FINGERPRINTED =
