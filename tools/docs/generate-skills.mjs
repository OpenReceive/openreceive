...
// maintained by hand:
//
//   1. skills/integrate-openreceive/references/{node,fastify,next,fastapi,django,rails,btcpay}.md are byte copies
...
const GENERATED_REFERENCES = [
  { source: "docs/agents/node.md", target: "skills/integrate-openreceive/references/node.md" },
  {
    ...
    target: "skills/integrate-openreceive/references/fastify.md",
  },
  { source: "docs/agents/next.md", target: "skills/integrate-openreceive/references/next.md" },
  {
    source: "docs/agents/fastapi.md",
    target: "skills/integrate-openreceive/references/fastapi.md",
  },
  {
    source: "docs/agents/django.md",
    target: "skills/integrate-openreceive/references/django.md",
  },
