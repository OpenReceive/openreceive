...
| `@openreceive/express` | Implemented | Mounted HTTP routes, auth hooks, signed event URLs, idempotent create/refresh, lookup, SSE events, settlement action hook, and static rates/routes/providers helpers. |
