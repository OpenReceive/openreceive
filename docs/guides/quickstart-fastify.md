...
Express: [quickstart-node.md](quickstart-node.md) · Next.js:
[quickstart-next.md](quickstart-next.md). This page is the Fastify one.
...
→ [openReceiveFastify](api-reference.md#openreceivefastify) ·
...
is Buy a Button
([`examples/buttons/server/fastify`](../../examples/buttons/server/fastify)).
