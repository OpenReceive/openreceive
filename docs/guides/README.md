...
7. [Automated Swaps](automated-swaps.md) - provider setup, payer flow, refunds, and settlement authority.
8. [App Route Protection](authorization.md) - middleware, controllers, CSRF, and CORS.
...
17. [Rails Quickstart](quickstart-rails.md) - mountable engine walkthrough.
